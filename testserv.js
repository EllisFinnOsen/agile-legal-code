...
function servicesNavLoaded() {
    ...
    // Check if jQuery is defined and wait until it is
    if (typeof jQuery === 'undefined') {
        console.error('jQuery is not loaded. Retrying...');
        setTimeout(servicesNavLoaded, 100); // Retry after 100ms
        return;
    }
    ...
    jQuery(function() {
        ...
        function reinitializeWebflowInteractions() {
            ...
            }, 200); // Adding a slight delay to ensure Webflow is fully initialized
        }
