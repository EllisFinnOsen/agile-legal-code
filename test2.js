// Add the event listener for service-toggle click before triggering waitless or any other behavior
document.addEventListener('DOMContentLoaded', function() {
    let serviceToggle = document.getElementById('service-toggle');
    
    if (serviceToggle) {
        serviceToggle.addEventListener('click', function() {
            console.log('Service toggle clicked.');

            // Trigger Waitless to load the scripts and run the functions
            waitless.triggerLoad(); // This will trigger any lazy-loaded iframes or scripts

            // You can also add any custom script loading logic here if needed.
        });
    } else {
        console.error('Service toggle element not found.');
    }
});
